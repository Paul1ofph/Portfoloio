      ...
      <div className="container mx-auto p-10">
        <div className="w-full lg:w-[60vw] mx-auto">
          ...
          <p className="text-sm text-center mt-4 leading-6">
            A versatile graphics designer and frontend developer with hands-on
            expertise in modern technologies, tools, and frameworks, dedicated
            to building efficient, scalable, and user-centric solutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-16 mt-16">
          <div>
            ...
            <a target="_blank" href="tel: +234-810-981-7134">
              <ContactInfoCard
                icon={<IoMdPhonePortrait />}
                text={ABOUT_ME.phone}
              />
            </a>
            <a target="_blank" href="https://github.com/Paul1ofph">
              <ContactInfoCard icon={<FaGitAlt />} text={ABOUT_ME.github} />
            </a>
            <a
              target="_blank"
              href="https://www.instagram.com/graphic_designer_in_ph?igsh=OGQ5ZDc2ODk2ZA%3D%3D&utm_source=qr"
            >
              <ContactInfoCard
                icon={<FaInstagram />}
          ...
          <div className="lg:ml-auto xl:w-[38rem]">
            <div className="relative left-1/2 flex w-[22rem] aspect-square border border-primary rounded-4 -translate-x-1/2 scale-75 md:scale-100 rounded-full">
