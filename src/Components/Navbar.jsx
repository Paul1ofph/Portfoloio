...
const Navbar = () => {
  ...
  return (
    <nav className="container mx-auto sticky top-5 z-10">
      <div className="flex items-center justify-between rounded-full  border border-primary backdrop-blur-[5px] m-5 p-3 md:p-0 ">
        {/* Logo */}
        ...
        <button
          className="block md:hidden mr-6 focus:outline-none"
          onClick={toggleMenu}
        >
          <svg
            className="w-6 h-6"
